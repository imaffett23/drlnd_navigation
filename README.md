...
Dependencies are installed by executing the first cell of `Navigation.ipynb`.  

### Instructions

In order to train the agent and save the model weights, simply run each cell in the `Navigation.ipynb` file. 